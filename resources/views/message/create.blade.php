                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('message.store', ['id' => $accomodation->id]) }}">
                            ...
                            <div class="form-group row">
                                <label for="object_email" class="col-md-4 col-form-label text-md-right">{{ __('oggetto della mail') }} *</label>
                            ...
                            <div class="form-group row">
                                <label for="email_sender" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }} *</label>
                            ...
                            <div class="form-group row">
                                <label for="content" class="col-md-4 col-form-label text-md-right">{{ __('scrivi il tuo messaggio') }} *</label>
                                <div class="col-md-6">
